...
class BarangMasukController extends Controller
{
    public function index(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'data' => compact('barangMasuks', 'barangs', 'kategoris')
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Transaksi barang masuk berhasil ditambahkan.'], 201);
    }
    ...
    public function destroy(BarangMasuk $barang_masuk)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Transaksi barang masuk berhasil dibatalkan.']);
    }
}
