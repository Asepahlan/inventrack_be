...
class SaldoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'data' => compact('topups', 'runningSaldo', 'totalTopup', 'totalMasuk', 'totalKeluar', 'ledger')
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Saldo berhasil didepositkan.'], 201);
    }
    ...
    public function destroy(Saldo $saldo)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Transaksi top up saldo berhasil dihapus.']);
    }
}
